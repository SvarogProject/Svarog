...
[System.Serializable]
public class _2dxFX_GrassMultiFX : _moiling_2dxFX_BaseClass
{
	...
	{	
		...
		if (ActiveChange)
		{
			...
			if (Wind!=null) rendererMaterial.SetFloat("_Wind", Wind.Evaluate(WindTime1));
			if (Wind!=null) rendererMaterial.SetFloat("_Wind2", Wind.Evaluate(WindTime2));
			if (Wind!=null) rendererMaterial.SetFloat("_Wind3", Wind.Evaluate(WindTime3));
			if (Wind!=null) rendererMaterial.SetFloat("_Wind4", Wind.Evaluate(WindTime4));
