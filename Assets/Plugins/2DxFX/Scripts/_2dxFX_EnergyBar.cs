...
[System.Serializable]
public class _2dxFX_EnergyBar : _moiling_2dxFX_BaseClass
{
	...
	{	
		...
		if (ActiveChange)
		{
			...
			rendererMaterial.SetFloat("_Value1", BarProgress);
			rendererMaterial.SetFloat("_Value2", 1-_Value2);
			rendererMaterial.SetFloat("_Value3", 1-_Value3);
			rendererMaterial.SetFloat("_Value4", _Value4);
			rendererMaterial.SetFloat("_Value5", _Value5);
