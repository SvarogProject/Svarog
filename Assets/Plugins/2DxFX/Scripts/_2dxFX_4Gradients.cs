...
[System.Serializable]
public class _2dxFX_4Gradients : _moiling_2dxFX_BaseClass
{
	...
	{	
		...
		if (ActiveChange)
		{
			...
			rendererMaterial.SetColor("_Color1", _Color1);
			rendererMaterial.SetColor("_Color2", _Color2);
			rendererMaterial.SetColor("_Color3", _Color3);
			rendererMaterial.SetColor("_Color4", _Color4);
		}
