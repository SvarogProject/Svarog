...
public class GameSceneManager : MonoBehaviour {
    ...
    public void CreateProgression()
    {
        ...
        int playerInt = chm.GetCharacterIndex(chm.Players[0].PlayerPrefab);
        ...
        for (int i = 0; i < progressionStages; i++)
        {
            ...
            s.charId = chm.CharacterList[charInt].CharacterId;
    ...
    public void LoadNextOnProgression()
    {
        ...
        else
        {
            ...
            chm.Players[1].PlayerPrefab = 
                chm.GetCharacterById(progression[progIndex].charId).Prefab;
