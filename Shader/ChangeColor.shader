    ...
    {   
        ...
        CGPROGRAM
            ...
            float4 frag (v2f i) : COLOR
            {
                ...
                c2 = c2-_ColorX2.rgb;
                c2 = abs(c2);
                if (c2.r<_Tolerance2) c.rgb=shifted2;
                if (c2.g<_Tolerance2) c.rgb=shifted2;
                if (c2.b<_Tolerance2) c.rgb=shifted2;               
                c.a = c.a-_Alpha2;
                ...
                c3 = c3-_ColorX3.rgb;
                c3 = abs(c3);
                if (c3.r<_Tolerance3) c.rgb=shifted3;
                if (c3.g<_Tolerance3) c.rgb=shifted3;
                if (c3.b<_Tolerance3) c.rgb=shifted3;               
                c.a = c.a-_Alpha3;
